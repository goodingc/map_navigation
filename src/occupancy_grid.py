...
class OccupancyGrid:
    ...
    def to_grid(self, world_x, world_y):
        """
        Converts grid coordinates to world coordinates, or None if world coordinates are out of bound
        @type world_x: float
        @type world_y: float
    ...
    def to_world(self, grid_x, grid_y):
        """
        Converts world coordinates to grid coordinates, or None if converted coordinates are out of bounds
        @author Callum
        @type grid_x: int
        @type grid_y: int
